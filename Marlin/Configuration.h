...
#define TEMP_SENSOR_0 5 /* ATC Semitec 104GT-2, tables in thermistortables match :) */
...
/* This may have been remove on purpose in a Marlan update */
...
#define Y_MIN_ENDSTOP_INVERTING false // non branché
#define Z_MIN_ENDSTOP_INVERTING true // palpeur B orange = FALSE / palpeur blanc 4-6mm = TRUE
#define X_MAX_ENDSTOP_INVERTING true // non branché
#define Y_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING true // non branché
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    // Initial/original for Dagoma Discovery 200
